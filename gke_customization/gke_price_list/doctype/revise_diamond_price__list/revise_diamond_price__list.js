...
// frappe.ui.form.on('Revise Diamond Price  List', {
...
frappe.ui.form.on('Revise Diamond Price List Details', {
...
frappe.ui.form.on('Revise Diamond Price List Details Sieve Size Range', {
	revised_rate:function(frm,cdt,cdn) {
		var d = locals[cdt][cdn];
		d.difference = d.revised_rate - d.rate_per_carat
...
frappe.ui.form.on('Revise Diamond Price List Details Size in MM', {
	revised_rate:function(frm,cdt,cdn) {
		var d = locals[cdt][cdn];
		d.difference = d.revised_rate - d.rate_per_carat
