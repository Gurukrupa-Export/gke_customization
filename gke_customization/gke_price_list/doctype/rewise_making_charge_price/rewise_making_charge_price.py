...
class RewiseMakingChargePrice(Document):
    def before_save(self):
        ...
        if name:
            if len(self.rewise_making_charge_price_item_subcategory) != len(frappe.get_doc("Making Charge Price",name).subcategory):
                if self.rewise_making_charge_price_item_subcategory==[]:
                    self.set("rewise_making_charge_price_item_subcategory", [])
                    ...
                    for j in sorted_data:
                        rate_details = self.append("rewise_making_charge_price_item_subcategory", {})
                    ...
                    old_making_charge_price_item_subcategory = [d.making_charge_price_item_subcategory for d in self.rewise_making_charge_price_item_subcategory]
                    sorted_data = []
            ...
            if len(self.rewise_making_charge_price_finding_subcategory) != len(frappe.get_doc("Making Charge Price",name).finding_subcategory):
                if self.rewise_making_charge_price_finding_subcategory==[]:
                    
                    self.set("rewise_making_charge_price_finding_subcategory", [])
                    ...
                    sorted_data = sorted(making_data, key=lambda x: x['subcategory'])
                    for j in sorted_data:
                        rate_details = self.append("rewise_making_charge_price_finding_subcategory", {})
                        rate_details.subcategory = j['subcategory']
                    ...
                    old_making_charge_price_item_subcategory = [d.making_charge_price_finding_subcategory for d in self.rewise_making_charge_price_finding_subcategory]
                    sorted_data = []
    ...
    def on_submit(self):
        ...
        if name:
            if self.rewise_making_charge_price_item_subcategory:
                for i in self.rewise_making_charge_price_item_subcategory:
            ...
            if self.rewise_making_charge_price_finding_subcategory:
                for i in self.rewise_making_charge_price_finding_subcategory:
