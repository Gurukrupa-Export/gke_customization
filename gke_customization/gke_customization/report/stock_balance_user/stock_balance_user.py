...
class StockBalanceUserFilter(TypedDict):
	company: str | None
	from_date: str
	to_date: str
	item_group: str | None
...
def execute(filters: StockBalanceUserFilter | None = None):
	return StockBalanceUserReport(filters).run()


class StockBalanceUserReport:
	def __init__(self, filters: StockBalanceUserFilter | None) -> None:
