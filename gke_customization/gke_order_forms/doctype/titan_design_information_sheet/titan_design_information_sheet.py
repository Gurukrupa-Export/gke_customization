...
#     similar_doc = frappe.get_doc('Titan Design Information Sheet',{'design_code':json_doc['design_code_2'],'design_code_2':json_doc['design_code']})
#     if similar_doc:
#         similar_doc.is_set=0
#         similar_doc.is_set=0
#         similar_doc.save()

#     return similar_doc.name
