...
def calculate_working_days(doc, method=None):
    ...
    end_date = last_day - timedelta(days=last_day.day)  # Subtract days to get the last day of the current month
    ...
    """
    # Execute the SQL query to count holidays
    ...
    working_days = total_days - holiday_count
     # Get the shift hours from the "Shift Type" linked to the default_shift
    if default_shift:
