...
from gke_customization.gke_catalog.api.portal_live_api.login import get_address_by_link_name
...
def get_new_created_issue(user_id, user_type, customer, subject, issue_type, description, priority):
    try:
        ...
        portal_link = "http://localhost:8080/"   # change this

        subject = f"Issue Created: {issue.name}"
        ...
        <div style="font-family: Arial, sans-serif; font-size: 14px;">
            ...
            <p>Your support ticket <b>{issue.name}</b> has been successfully created.</p>

            <p>
                You can track and respond to this issue by logging into the portal.
            </p>
            ...
            <p>
                After login, go to:
                <br>
                👉 <b>Notification Tab</b> or <b>Support Section</b>
                <br>
                to view and take action on this issue.
            </p>
        ...
        if user_type == "User":
            customer_email = frappe.db.get_value(
                ...
                "email_id"         # Field you want
            )
                        
            frappe.sendmail(
                recipients=customer_email,  # dynamic email
            ...
            assigned_user = customer_doc.custom_customer_representatives

            assign_to_user = []

            for i in assigned_user:
                assign_to_user.append(i.user_id)

            frappe.sendmail(
                recipients=assign_to_user,  # dynamic email
                sender = "shubham_s@gkexport.com",
                subject=subject,
                message=html_content,
                reference_doctype="Issue",
