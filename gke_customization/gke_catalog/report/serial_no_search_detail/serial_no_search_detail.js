...
frappe.query_reports["Serial No Search Detail"] = {
    filters: [
        {
    ...
    onload: function(report) {
        ...
        report.page.add_inner_button(__("View Summary Report"), function () {
            ...
            if (current_filters.search_mode === "Single" && current_filters.serial_no) {
                current_filters.search_text = current_filters.serial_no;
            }
            frappe.set_route("query-report", "Serial No Search Summary", current_filters);
        });
        ...
        $(document).on("click", ".view-details-btn", function() {
            ...
            frappe.call({
                method: "gke_customization.gke_catalog.report.serial_no_search_detail.serial_no_search_detail.get_raw_material_details",
                args: {
                    serial_no: serial_no,
                    item_code: item_code
                },
