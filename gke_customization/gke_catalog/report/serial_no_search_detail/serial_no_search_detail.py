...
def get_columns():
    return [
        ...
        {"fieldname": "tag_no", "label": _("Serial No"), "fieldtype": "Link", "options": "Serial No", "width": 150},
        ...
        {"fieldname": "batch_no", "label": _("MWO"), "fieldtype": "Data", "width": 180},
        ...
        {"fieldname": "style_bio", "label": _("Jewelex Stylebio"), "fieldtype": "Data", "width": 140},
        ...
        {"fieldname": "dia_purity", "label": _("Dia Quality"), "fieldtype": "Data", "width": 120},
    ]
...
def get_data(filters):
    ...
    if filters.get("search_mode") == "Single":
        ...
        search_values = [serial_no] if serial_no else []
    else:
