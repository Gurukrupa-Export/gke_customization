...
frappe.query_reports["Accounts Receivable Summary - SD"] = {
	filters: [
		{
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Receivable"), function () {
			...
			frappe.set_route("query-report", "Accounts Receivable - SD", { company: filters.company });
		});
	},
};

erpnext.utils.add_dimensions("Accounts Receivable Summary - SD", 9);
