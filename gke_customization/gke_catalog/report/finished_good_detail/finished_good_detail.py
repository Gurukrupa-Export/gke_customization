...
def get_columns():
    return [
        ...
        {"label": _("Customer PO no."), "fieldname": "main_po_no", "fieldtype": "Data", "width": 150},
        {"label": _("child po no."), "fieldname": "po_no", "fieldtype": "Data", "width": 150},
...
def get_data(filters):
    ...
    user_default_department = frappe.defaults.get_user_default("department")

    if is_admin_user or is_system_manager:
        selected_department = filters.get("department")
    else:
        selected_department = user_default_department

    if selected_department:
        conditions.append("w.department = %(department)s")
        query_filters["department"] = selected_department
