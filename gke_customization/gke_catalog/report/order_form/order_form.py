...
def get_columns():
    return [
        ...
        {"label": "Order Count(No. of Items)", "fieldname": "order_count", "fieldtype": "Data", "width": 150},
        {"fieldname": "no_of_orders", "label": "No. of Pcs(Quantity of item in the order)", "fieldtype": "Data", "width": 150},
        ...
        {"fieldname": "time_difference", "label": "Time Difference (Difference between created date-time and status date-time)", "fieldtype": "Data", "width": 250},
        {"fieldname": "status_duration", "label": "Status Duration (Difference between status date-time and current date-time)", "fieldtype": "Data", "width": 250},
        {"fieldname": "target_days", "label": "Target Days", "fieldtype": "Data", "width": 110},
       {"fieldname": "total_metal_weight", "label": "Metal Wt", "fieldtype": "Data", "width": 120},
...
def get_data(filters):
    ...
    for row in data:
        ...
        row["orderform_id"] = f'<a href="http://192.168.64.135:8000/app/order-form/{encoded_form_name}" target="_blank">{row["orderform_id"]}</a>'
