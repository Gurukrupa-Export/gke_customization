...
frappe.query_reports["Accounts Payable - SD"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Payable Summary"), function () {
			...
			frappe.set_route("query-report", "Accounts Payable Summary - SD", { company: filters.company });
		});
	},
};

erpnext.utils.add_dimensions("Accounts Payable - SD", 10);
