...
def get_columns():
    return [
        {"fieldname": "btn_detail",  "label": _("Detail"), "fieldtype": "Data", "width": 80},
        {"fieldname": "btn_diff",    "label": _("Diff."),  "fieldtype": "Data", "width": 80},

        {"fieldname": "tag_no",     "label": _("Serial No"),     "fieldtype": "Data", "width": 130},
        {"fieldname": "batch_no",     "label": _("Order No"),     "fieldtype": "Data", "width": 110},

        {"fieldname": "style_bio",  "label": _("Item Code"),  "fieldtype": "Data", "width": 120},
...
def build_conditions(filters):
    conditions = ["ro.docstatus < 2", "ro.bom IS NOT NULL", "ro.bom != ''", "ro.new_bom IS NOT NULL", "ro.new_bom != ''"]
    values     = {}
