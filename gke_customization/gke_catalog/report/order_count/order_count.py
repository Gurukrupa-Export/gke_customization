...
def get_columns():
    return [
        ...
        {"label": "No.of Pcs(Quantity of each item in the order)", "fieldname": "qty", "fieldtype": "Data", "width": 180},
        ...
        {"label": "Time Difference (Difference between created date-time and status date-time)", "fieldname": "time_difference", "fieldtype": "Data", "width": 230},
        {"label": "Status Duration (Difference between status date-time and current date-time)", "fieldname": "status_duration", "fieldtype": "Data", "width": 250},
...
def get_data(filters):
    ...
    for row in data:
        ...
        row["orderform_id"] = f'<a href="http://192.168.64.135:8000/app/order/{encoded_form_name}" target="_blank">{row["orderform_id"]}</a>'
