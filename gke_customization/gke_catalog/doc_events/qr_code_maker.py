...
def get_qr_code(data: str, box_size: int = 10) -> str:
	qr_code_bytes = get_qr_code_bytes(data, format="PNG",box_size=10)
...
def get_qr_code_bytes(data, format: str, box_size: int) -> bytes:
